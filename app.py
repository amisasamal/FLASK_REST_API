...
video_update_args.add_argument("views", type=str, help="Views of the video", required=True)
video_update_args.add_argument("likes", type=str, help="Likes on the video", required=True)
...
class Video(Resource):
    ...
    def put(self, video_id):
        ...
        db.session.commit()
        return marshal(video, resource_fields), 201
